...
if (array_key_exists('theater', $_POST)) {
    ...
    $date = date('y-m-d');
    $query = "select movie_name, start_time as start_time from timetable_view where theater_name='$theater' and date(start_time)='$date'";
...
<head>
    ...
    <title>МовладоГрад</title>
</head>

<body>
    <div class="container">
        <div class="header clearfix">
            <a href="index.php" class="logo">МовладоГрад</a>
            <ul class="menu">
    ...
    <div class="footer">
        ...
        <div class="footer_block">
            ...
            <p>Администратор <span>+7 (982) 140-70-81</span></p>
        </div>
        <div class="footer_bottom">
            <div class="copyright">
                <p>&#169; Хашаев Мовлади 2023 Все права защищены</p>
            </div>
